    ...
    private void jsonFormat(JSONObject response) {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                model.setVote_average(String.valueOf(vote));
                model.setRelease_date(movieObject.getString("release_date"));
                model.setPoster("http://image.tmdb.org/t/p/w500/" + movieObject.getString("poster_path"));
        ...
        adapter.notifyDataSetChanged();
        Log.i("movies", "" + movies.get(0).getVote_average());
    }
